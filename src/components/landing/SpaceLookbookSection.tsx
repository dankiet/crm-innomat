...
import { fetchPublicSpaceCollectionsFn } from "@/api/lp";
...
export function SpaceLookbookSection({
  ...
  return (
    ...
    >
      ...
      {/* 3. Space Gallery Grid (Arch Journal Style) */}
          ...
          return (
            ...
            >
              ...
              <div
                ...
                onClick={() => onOpenMaterialModal(item.product)}
                role="button"
                tabIndex={0}
                onKeyDown={(e) => {
                  if (e.key === "Enter" || e.key === " ") {
                    e.preventDefault();
                    onOpenMaterialModal(item.product);
                  }
                }}
              ...
              >
                ...
                <div className="space-visual-badges">
                  ...
                  <span className="space-index-chip">0{index + 1}</span>
                </div>
