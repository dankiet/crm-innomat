...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Mobile: near full-screen sheet; Desktop: centered modal
        "fixed z-50 grid w-full gap-4 border bg-background shadow-lg duration-200",
        "inset-x-0 bottom-0 top-auto max-h-[92dvh] rounded-t-2xl p-4 pb-[max(1rem,env(safe-area-inset-bottom))] overflow-y-auto",
        "sm:inset-auto sm:left-[50%] sm:top-[50%] sm:bottom-auto sm:max-h-[90vh] sm:max-w-lg sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg sm:p-6",
