  ...
  return (
    <div className="space-y-7">
      ...
      <section className="grid gap-5 xl:grid-cols-[.9fr_1.1fr]">
        ...
        <div className="crm-surface rounded-2xl p-5 sm:p-6"><div className="mb-5 flex items-center justify-between"><div><p className="crm-eyebrow">Shortcuts</p><h3 className="mt-1 text-lg font-bold tracking-tight">Đi nhanh đến workspace</h3></div><ArrowUpRight className="size-5 text-primary" /></div><div className="grid gap-3 sm:grid-cols-2"><Shortcut href="/khach-hang" icon={Users} title="Khách hàng" text="Tìm kiếm, phân loại và chăm sóc hồ sơ." /><Shortcut href="/co-hoi" icon={TrendingUp} title="Cơ hội" text="Theo dõi pipeline và giai đoạn bán hàng." /><Shortcut href="/san-pham" icon={Package} title="Sản phẩm" text="Tra cứu catalog và chỉnh dữ liệu." /><Shortcut href="/luu-tru" icon={FileText} title="Lưu trữ" text="Mở kho ảnh và quản lý concept." /><Shortcut href="/cong-no" icon={Wallet} title="Công nợ" text="Theo dõi thanh toán và đối chiếu." /><Shortcut href="/ghi-chu" icon={FileText} title="Ghi chú" text="Ghi lại thông tin quan trọng." /></div></div>
      </section>
    </div>
  );
}

function Shortcut({ href, icon: Icon, title, text }: { href: "/khach-hang" | "/co-hoi" | "/san-pham" | "/luu-tru" | "/cong-no" | "/ghi-chu"; icon: typeof Users; title: string; text: string }) {
